...
class GroupsSlider extends React.Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		const content = groups.map((gr, index) => <GroupItem key={index} group={gr} />);
		return (
...
GroupsSlider.propTypes = {
	classes: PropTypes.object.isRequired
};

const mapStateToProps = (state) => ({});

export default connect(mapStateToProps, {})(withStyles(styles, { withTheme: true })(GroupsSlider));
