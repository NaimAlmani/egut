			...
			<ExpansionPanel classes={{ root: classes.mainPanelRoot, expanded: classes.mainPanelRoot }}>
				...
				>
					<Typography className={classes.heading}>
						...
						</span>Kontakt personer
						<div className={classes.countCont}>{this.props.contacts.length + ' Kontaktar'}</div>
					</Typography>
				</ExpansionPanelSummary>
				<ExpansionPanelDetails>
						...
						<ListItem classes={{ root: classes.listItemRoot }} onClick={this.props.onClick}>
							...
							<div className={classes.textCont}>
								<Typography noWrap={true} component='p'>
									<span className={classes.text}>lägg till en ny kontakt</span>
								</Typography>
							</div>
						</ListItem>
						<ContactTable contacts={this.props.contacts} activityID={this.props.activityID} />
					</List>
				</ExpansionPanelDetails>
			</ExpansionPanel>
		);
