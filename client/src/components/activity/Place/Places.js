				...
				>
					<Typography className={classes.heading}>
						<span style={{ marginRight: '10px' }}>
							<IconItem name='map' size={'1rem'} />
						</span>Lokaler
						<div className={classes.countCont}>{this.props.places.length + ' Lokaler'}</div>
					</Typography>
				</ExpansionPanelSummary>
				<ExpansionPanelDetails>
						...
						<ListItem classes={{ root: classes.listItemRoot }} onClick={this.props.onClick}>
							...
							<div className={classes.textCont}>
								<Typography noWrap={true} component='p'>
									<span className={classes.text}>lägg till en ny lokal</span>
								</Typography>
							</div>
						</ListItem>
						<PlaceFeed places={this.props.places} activityID={this.props.activityID} />
					</List>
				</ExpansionPanelDetails>
			</ExpansionPanel>
		);
...
export default connect(mapStateToProps, { deleteOrg })(withStyles(styles, { withTheme: true })(Places));
