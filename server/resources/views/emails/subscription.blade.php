...
padding:10px;
    ...
    <div class="envelop">
    <h4>Hej <span class="recieverName">!</span></h4>
    <p class="message">tack för ditt prenumeration</p>
    <p class="message">Välkommen till våra webbplatsnyheter så får du våra senaste nyheter via e-post</p>
